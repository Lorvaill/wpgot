...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'gameofthrones_6ca31990a2319ce79754_20220204130643_archive.zip';
	const ARCHIVE_SIZE		 = '45634726';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6ca3199-04130643';
    const SECONDARY_PACKAGE_HASH = 'f5adfcb-04130643';
	const VERSION			 = '1.4.4';
